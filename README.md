...
- **1 subagent** (`kimi-rescue`) — proactively delegates long-context analysis, adversarial review, or autonomous edits to Kimi (Moonshot K2.5, 256K context). Mirrors `codex-rescue` but for Kimi.
